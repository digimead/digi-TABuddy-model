...
import org.digimead.tabuddy.model.TestDSL.NoteLocation
...
class YAMLSerializationSpec_j1 extends FunSpec with ShouldMatchers with LoggingHelper with Loggable {
  ...
  describe("A YAMLSerialization") {
    it("should provide serialization mechanism for Model") {
      ...
      // serialize
      val s = new YAMLSerialization
      var frozen: Seq[String] = Seq()
      ...
      def fSave(element: Element.Generic, data: String) {
