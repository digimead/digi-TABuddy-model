...
/**
 * In the moment of child modification (include/remove), all ancestors of child are valid.
 */
object Event extends mutable.Publisher[Event] {
   ...
   */
  case class ChildInclude[T <: Element](sourceArg: Node[_ <: Element], newValueArg: Node[T],
   ...
   */
  case class ChildRemove[T <: Element](sourceArg: Node[_ <: Element], oldValueArg: Node[T],
    val modified: Element.Timestamp)(val undoF: () ⇒ Unit)
   ...
   */
  case class ChildReplace[T <: Element](sourceArg: Node[_ <: Element], oldValueArg: Node[T], newValueArg: Node[T],
    val modified: Element.Timestamp)(val undoF: () ⇒ Unit)
   ...
   */
  case class ChildrenReset(sourceArg: Node[_ <: Element],
    val modified: Element.Timestamp)(val undoF: () ⇒ Unit)
    extends PropertyChangeEvent(sourceArg, sourceArg.id.name, null, null) with Event
  case class ValueInclude[T <: Element](sourceArg: T,
  ...
  case class ValueRemove[T <: Element](sourceArg: T,
  ...
  case class ValueUpdate[T <: Element](sourceArg: T,
    oldValueArg: Value[_ <: AnyRef with java.io.Serializable],
    newValueArg: Value[_ <: AnyRef with java.io.Serializable],
    val modified: Element.Timestamp)(val undoF: () ⇒ Unit)
  ...
  case class ElementUpdate[T <: Element](sourceArg: T,
    oldValueArg: Option[Element], newValueArg: Element,
    val modified: Element.Timestamp)(val undoF: () ⇒ Unit)
    extends PropertyChangeEvent(sourceArg, sourceArg.eId.name, oldValueArg, newValueArg) with Event
}
